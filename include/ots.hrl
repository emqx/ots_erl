...
-define(ots_sql_gpb_version, "4.19.5").
...
-record('PutTimeseriesDataRequest',
        {table_name             :: unicode:chardata() | undefined, % = 1, required
         rows_data              :: ots_sql:'TimeseriesRows'() | undefined, % = 2, required
...
-record('PutTimeseriesDataResponse',
        {failed_rows = []       :: [ots_sql:'FailedRowInfo'()] | undefined, % = 1, repeated
         meta_update_status     :: ots_sql:'MetaUpdateStatus'() | undefined % = 2, optional
        }).
-endif.
